...
Rutba Media Server is Copyright (C) 2026 Tech Style Ltd (Company No.
...
By default, this server is licensed under the GNU Affero General Public
...
to use this server — for example, embedding it in a closed-source product,
distributing a modified version without publishing the source, or
operating it as a hosted service without the §13 source-availability
