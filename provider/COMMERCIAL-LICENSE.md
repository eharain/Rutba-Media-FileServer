...
strapi-provider-upload-media is Copyright (C) 2026 Tech Style Ltd
(Company No. 11101491), registered in England & Wales — https://tech-style.co

This software is dual-licensed.

## Open-source use — GNU AGPL v3.0

By default, this package is licensed under the GNU Affero General Public
...
to use this package — for example, embedding it in a closed-source
